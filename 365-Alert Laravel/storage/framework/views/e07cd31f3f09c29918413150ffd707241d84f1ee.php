...
<article class="about_team">
    <section class="about">
        ...
        <a href="https://www.linkedin.com/in/alexandru-darii/"><img id="linkedin" src="<?php echo e(URL::asset('pictures/About_Linkedin.svg')); ?>" alt=""></a>
    </section>
    <section class="about">
        ...
        <h3 id="title">Junior Web Developer</h3>
        <h4 id="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum quia velit quos reiciendis doloribus. Tenetur soluta, exercitationem, eveniet veniam dolorem ea vero repudiandae voluptas placeat, suscipit sed necessitatibus dignissimos dolor!</h4>
        <a href="https://www.linkedin.com/in/diogo-cordas/"><img id="linkedin" src="<?php echo e(URL::asset('pictures/About_Linkedin.svg')); ?>" alt=""></a>
    </section>
    <section class="about">
        ...
        <h3 id="title">Junior Web Developer</h3>
        <h4 id="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum quia velit quos reiciendis doloribus. Tenetur soluta, exercitationem, eveniet veniam dolorem ea vero repudiandae voluptas placeat, suscipit sed necessitatibus dignissimos dolor!</h4>
        <a href="https://www.linkedin.com/in/elsafreitasribeiro/"><img id="linkedin" src="<?php echo e(URL::asset('pictures/About_Linkedin.svg')); ?>" alt=""></a>
    </section>
    <section class="about">
        ...
        <h3 id="title">Junior Web Developer</h3>
        <h4 id="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum quia velit quos reiciendis doloribus. Tenetur soluta, exercitationem, eveniet veniam dolorem ea vero repudiandae voluptas placeat, suscipit sed necessitatibus dignissimos dolor!</h4>
        <a href="https://www.linkedin.com/in/john-olivier-maia/"><img id="linkedin" src="<?php echo e(URL::asset('pictures/About_Linkedin.svg')); ?>" alt=""></a>
    </section>
    <section class="about">
        <img src="<?php echo e(URL::asset('pictures/About_Jude.jpg')); ?>" alt="photo_jude">
        <h2 id="name">Jude Treanor</h2>
        <h3 id="title">Junior Web Developer</h3>
        <h4 id="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum quia velit quos reiciendis doloribus. Tenetur soluta, exercitationem, eveniet veniam dolorem ea vero repudiandae voluptas placeat, suscipit sed necessitatibus dignissimos dolor!</h4>
        <a href="https://www.linkedin.com/in/jude-treanor/"><img id="linkedin" src="<?php echo e(URL::asset('pictures/About_Linkedin.svg')); ?>" alt=""></a>
    </section>
</article>
